...
export default function HowItWorksHero() {
  const scrollToFlow = () => {
    document.getElementById('choose-your-flow')?.scrollIntoView({ behavior: 'smooth', block: 'start' });
  };
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-32">
        ...
        >
          Nourie adapts to your rhythm, offering seamless pre-orders, flexible subscriptions, and instant deliciousness. Discover how we bring premium, affordable meals to your doorstep.
        </motion.p>
        ...
        >
          <span className="text-sm font-medium mb-2">Explore Your Options</span>
          <motion.div
            animate={{ y: [0, 8, 0] }}
